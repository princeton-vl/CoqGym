...
from helpers import get_tactic_targets, get_tactics_true, get_args_true, get_tactics_pred, prep_asts, get_lc_targets, get_lc_pred
...
class GastLC(nn.Module):
    def __init__(self, opts):
        ...
        self.classifier_1 = Linear(51*self.dense_dim, self.opts.embedding_dim//2)
        self.drop_out = Dropout(self.opts.dropout)
        self.classifier_2 = Linear(self.opts.embedding_dim//2, 50)
    ...
    def forward(self, batch):
        ...
        for lc_asts in lc_asts_s:
            x_lc, edge_index_lc, gnn_batch = prep_asts(self.opts, lc_asts, 50)
    ...
    def prove(self, goal, lc, gc):
        ...
        x, edge_index, batch = prep_asts(self.opts, asts, 51)
